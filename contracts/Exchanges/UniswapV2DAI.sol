...
contract UniswapV2DAI is PredaDexConsts, IConsts {
    ...
    IERC20 constant internal MID_TOKEN = DAI;
    ...
    external override view checkFlags(flags, FLAG_DISABLE_UNISWAP_V2_ALL) checkFlags(flags, FLAG_DISABLE_UNISWAP_V2_DAI)
    returns (uint256[] memory rets, uint256 gas) {
        uint256 gas1;
        uint256 gas2;
